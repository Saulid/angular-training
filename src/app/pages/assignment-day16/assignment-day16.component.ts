...
export class AssignmentDay16Component implements OnInit, AfterViewInit {
  ...
  employeeList: Employee[] = [
    { id: 1, name: 'Aung Aung', department: 'Information Technology (IT)', gender: 'Male', position: 'Senior', phoneNumber: '09123456780', joinDate: '22-6-2018' },
    ...
    { id: 4, name: 'Mg Mg', department: 'Application Development', gender: 'Male', position: 'Senior', phoneNumber: '09123456783', joinDate: '1-4-2019' },
    { id: 5, name: 'Hla Yee', department: 'Application Management', gender: 'Female', position: 'Junior', phoneNumber: '09123456784', joinDate: '1-5-2019' },
    { id: 6, name: 'Kyaw Lin', department: 'Application Management', gender: 'Male', position: 'Junior', phoneNumber: '09123456781', joinDate: '1-7-2019' },
    { id: 7, name: 'Mya Mya', department: 'Business Intelligence (BI)', gender: 'Female', position: 'Senior', phoneNumber: '09123456785', joinDate: '1-7-2019' },
    { id: 8, name: 'War So', department: 'Business Intelligence (BI)', gender: 'Female', position: 'Senior', phoneNumber: '09123456786', joinDate: '3-6-2019' },
